...
const chapters = [
  {
    num: 19, title: "Ang Mitsa", speaker: "Tagasalaysay: ANGELICA MADERAZO",
    ...
    dialogue: "Ang kabanata ay tungkol sa pag-usbong ng galit ng mga tao at kung paano ang maliit na pangyayari ay maaaring magsilbing simula ng paghihimagsik.",
    scene: "fuse",
    buod: `Sa kabanatang ito, ipinakita ang lumalalang galit ng mga mamamayan dahil sa patuloy na pang-aapi ng mga nasa kapangyarihan. Ang "mitsa" ay sumisimbolo sa isang maliit na pangyayari na maaaring magdulot ng malaking kaguluhan o pag-aalsa.
          Makikita na ang mga estudyante at ilang mamamayan ay nagsisimula nang mag-isip ng pagtutol sa pamahalaan dahil sa kawalang-katarungan. Samantala, si Simoun ay patuloy na naghahanda at naghihintay ng tamang pagkakataon upang maisakatuparan ang kanyang plano na magpasiklab ng rebolusyon.
          Ipinapakita rin dito na kapag matagal nang naiipon ang galit at hinanakit ng mga tao, kahit maliit na insidente ay maaaring maging dahilan ng malaking pagbabago.`,
    characters: [
      { name: "Simoun", color: "#2c2c2c", accent: "#f5c842" },
      { name: "Basilio", color: "#8B4513", accent: "#c8a46e" },
    ],
    quiz: { q: "Ano ang sinisimbolo ng 'mitsa' sa kabanatang ito?", choices: ["Ang tapang ni Simoun na harapin ang mga kaaway niya.", "Ang isang maliit na pangyayari na maaaring magpasimula ng malaking pag-aalsa o rebolusyon.", "Ang pagibig ni Basilio sa kanyang minamahal.", "Ang katahimikan ng lipunan bago dumating ang Kastila."], correct: 1, feedback: "Tama! Ang 'mitsa' ay sumisimbolo sa isang maliit na pangyayari na, kapag naapoy, ay maaaring magdulot ng malaking paghihimagsik — tulad ng naiisip ni Simoun para sa rebolusyon." }
  },
  {
    num: 20, title: "Ang Tagahatol", speaker: "Tagasalaysay: ANGELICA MADERAZO",
    image: "https://images.esquiremag.ph/esquiremagph/images/2020/06/17/old-school-photos-main-image1.jpg",
    dialogue: "Ang kabanata ay tungkol sa isang hindi makatarungang panghuhusga na nagpapakita ng katiwalian sa sistema, kung saan ang kapangyarihan ang nangingibabaw kaysa sa katotohanan.",
    scene: "crowd",
  ...
  {
    num: 21, title: "Mga Anyo ng Maynila", speaker: "Tagasalaysay: ANGELICA MADERAZO",
    ...
    scene: "manila",
    buod: `Sa kabanatang ito, ipinakita ang iba't-ibang kalagayan ng mga tao sa Maynila—ang mayayaman at ang mahihirap. Nahahati ang lungsod sa dalawang uri ng pamumuhay: ang marangya at masayang buhay ng mga nakaaangat, at ang mahirap ay puno ng suliraning buhay ng mga naaapi.
  ...
  {
    num: 22, title: "Ang pagtatanghal", speaker: "Tagasalaysay: ANGELICA MADERAZO",
  ...
  {
    num: 23, title: "Isang Bangkay", speaker: "Tagasalaysay: ANGELICA MADERAZO",
  ...
  {
    num: 24, title: "Mga Panaginip", speaker: "Tagasalaysay: ANGELICA MADERAZO",
    image: "https://images.esquiremag.ph/esquiremagph/images/2020/06/16/old-school-photos-8.jpg",
    dialogue: "Ang kabanatang ito ay tungkol sa mga panaginip ng mga tauhan na nagpapakita ng kanilang damdamin, takot, at alaala ng nakaraan..",
    scene: "dream",
    buod: `Sa kabanatang ito, ipinakita ang iba't-ibang panaginip ng mga tauhan, lalo na si Basilio. Sa kanyang panaginip, nakita niya ang kanyang ina na si Sisa, na tila nagbibigay babala at paalala tungkol sa kanyang nakaraan.
  ...
  {
    num: 25, title: "Tawanan at Iyakan", speaker: "Tagasalaysay: ANGELICA MADERAZO",
    image: "https://images.esquiremag.ph/esquiremagph/images/2022/06/11/index-1-29720220611.jpg",
    dialogue: "Ang kabanatang ito ay tungkol sa magkasabay na kasiyahan at kalungkutan ng mga tao, na nagpapakita ng hindi pagkakapantay-pantay sa lipunan.",
    scene: "end",
...
function selectPreview(idx) {
  ...
  // Set buod text safely
  const pvBuod = document.getElementById('pvBuod');
  if (pvBuod) pvBuod.textContent = ch.buod;

  // Populate characters in preview panel
...
// ── audio ──
const spAudioSrcs = [
  './audios/kabanata_19.mp3',
  './audios/kabanata_20.mp3',
  './audios/kabanata_21.mp3',
  './audios/kabanata_22.mp3',
  './audios/kabanata_23.mp3',
  './audios/kabanata_24.mp3',
  './audios/kabanata_25.mp3'
];
